...
{p 4 8 2}Hwang J., Kang B., and Lee S. (2018) A Doubly Corrected Robust Variance Estimator for Linear GMM, {it:working paper}.{p_end}
...
{p 4 8 2}Lee, S. and Hansen, B. E.(2018) Inference for iterated GMM under misspecification and clustering, {it: working paper}.{p_end}
...
{title:Author}
{p 4}Jungbin Hwang ( jungbin.hwang@uconn.edu ){p_end}
{p 4}Byunghoon Kang ( b.kang1@lancaster.ac.uk ){p_end}
{p 4}Seojeong Lee ( jay.lee@unsw.edu.au ){p_end}
{title:Also see}
